        ...
        <div className="right">
            ...
            <div className="more">
                <div className="more-card">
                    <div className="more-header">更多</div>
                    <ul id="more-links">{moreLinks.map((item) => links(item, 'more-link'))}</ul>
                </div>
            </div>
            <div className="friend-links">
                <div className="friend-links-card">
                    <div className="friend-links-header">友情链接</div>
                    <ul id="friend-links">{friendLinks.map((item) => links(item, 'more-link'))}</ul>
                </div>
            </div>
            <div className="copyright">
                <div id="copyright-card">
                    <p className='J-company-name'> © 2021 今日头条</p>
                    <p>
