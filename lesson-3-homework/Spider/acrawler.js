...
window.navigator = {
    userAgent: "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4442.4 Safari/537.36",
}
...
function _signature(_t) {
    return window.byted_acrawler.sign({url: _t});
}
